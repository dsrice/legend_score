...
var (
	userTokenDBTypes = map[string]string{`ID`: `int`, `UserID`: `int`, `Token`: `varchar`, `RefreshToken`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `DeletedFLG`: `tinyint`, `DeletedAt`: `datetime`}
	_                = bytes.MinRead
)
